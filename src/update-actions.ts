 ...
 *
 * Rendered nothing until `T717-P2` backfilled the metadata feed's `runtimeVersions`, and now renders
 * whenever the installer is behind: measured 2026-09-03, `1.13.4` carries Electron `43.1.1` and `1.13.7`
